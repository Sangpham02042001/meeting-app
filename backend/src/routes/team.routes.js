...
const { getTeamInfo, createTeam, getTeamCoverPhoto,
  ...
  getAllTeams, getTeamMeetings, confirmRequest,
  getTeamMessages } = require('../controllers/team.controller')
...
router.route('/api/teams/:teamId/confirm-requests')
  .put(isTeamAdmin, confirmRequest)
