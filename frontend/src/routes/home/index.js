...
import { Dialog, DialogActions, DialogTitle, DialogContent, IconButton, Modal, Tooltip } from '@mui/material';
				...
				<div>
					...
					>
						<Tooltip title="Feedback">
							<BugReportIcon style={{ color: 'var(--icon-color)' }} />
						</Tooltip>
					</IconButton>
					...
					<Dialog
						...
						maxWidth='sm' fullWidth={true}
					>
						<DialogTitle style={{ backgroundColor: 'var(--primary-bg)' }}>Feedback</DialogTitle>
						...
						<DialogActions style={{ backgroundColor: 'var(--primary-bg)' }}>
							<Button variant="text"
								style={{ color: 'var(--icon-color)' }}
								endIcon={<SendIcon style={{ color: 'var(--icon-color)' }} />}
